...
-- Volcando estructura de base de datos para bd_gimnasio
CREATE DATABASE IF NOT EXISTS `bd_gimnasio` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bd_gimnasio`;

-- Volcando estructura para tabla bd_gimnasio.gimnasio_clientes
CREATE TABLE IF NOT EXISTS `gimnasio_clientes` (
...
-- Volcando estructura para tabla bd_gimnasio.listado_membresias
...
-- Volcando estructura para tabla bd_gimnasio.membresia_clientes
CREATE TABLE IF NOT EXISTS `membresia_clientes` (
  ...
  CONSTRAINT `FK_membresia_clientes_gimnasio_clientes` FOREIGN KEY (`cod_cliente`) REFERENCES `gimnasio_clientes` (`cod_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
